...
for (let i = 0; i < click.length; i++) {
  click[i].addEventListener("click", function (event) {
    ...
    if (typeof Storage !== "undefined") {
      let item = {
        id: i + 1,
        name: event.target.parentElement.children[0].children[0].children[0]
          .textContent,
        description:
          event.target.parentElement.children[0].children[0].children[1]
            .textContent,
        price:
          event.target.parentElement.children[0].children[0].children[2]
